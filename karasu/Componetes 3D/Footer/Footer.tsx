  ...
  return (
    <>
      <Container>
        <ContainerLeft>
          <ContainerTitulo>
            <ClickableIcon1 href="https://karasucorp.com/">
              Clientes <FaHeadSideVirus />
            </ClickableIcon1>
          </ContainerTitulo>
          <Paragrafo>
            Seja muito bem-vindo! Ao prosseguir, você será direcionado para o
            nosso site, onde encontrará informações detalhadas sobre nossos
            serviços, projetos e expertise.
          </Paragrafo>
        </ContainerLeft>

        <ContainerLeft>
          <ContainerTitulo>
            <ClickableIcon1 href="/Recrutadores">
              Recrutores <MdWork />
            </ClickableIcon1>
          </ContainerTitulo>
          <Paragrafo>
            Apresento orgulhosamente minhas certificações e meu portfólio,
            evidenciando minha dedicação à excelência no mundo tecnológico.
          </Paragrafo>
        </ContainerLeft>
        ...
        <ContainerRight>
          ...
          <ContainerIcons>
            <ClickableIcon
              href="https://api.whatsapp.com/send?phone=+55+5511919216813&text=Ol%C3%A1%2C+estou+vindo+porqu%C3%AA+o+corvo+disse...."
            >
              <FaWhatsapp />
            </ClickableIcon>
          </ContainerIcons>
